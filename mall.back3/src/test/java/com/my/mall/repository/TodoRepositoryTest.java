...
public class TodoRepositoryTest {
	...
	public void selectTodo() {
		Long todoNo = 2L; //명시적으로 L은 Long타입의 2라는뜻
		Optional<Todo> result = todoRepository.findById(todoNo);
		Todo todo = result.orElseThrow(); //todo or NosearchElementException return
		log.info(todo);
	}
	...
	public void testPaging() {
		...
		Page<Todo> result = todoRepository.findAll(pageable); // Pageable에 맞는 Page Todo 생성
